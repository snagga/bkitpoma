...
import com.poma.bkitpoma.client.localization.LRegisterForm;
...
public class RegisterForm extends FormPanel {
	...
	public RegisterForm() {
		 ...
		 */
		this.add(new Button(local.button_submit(), new ButtonListenerAdapter() {
			@Override
		...
		this.add(new Button("Insert field", new ButtonListenerAdapter() {
			@Override
			public void onClick(Button button, EventObject e) {
				// TODO Auto-generated method stub
