...
public class WayPoint extends Entity implements IsSerializable {
	...
	public WayPoint(String time, String trackid, String longtitude,
			String lattitude, String speed) {
		hash.put("time", time);
	...
	public LatLng getLatLng() {
		return LatLng.newInstance(Double.parseDouble(getLattitude()), Double
				.parseDouble(getLongtitude()));
	}
}
