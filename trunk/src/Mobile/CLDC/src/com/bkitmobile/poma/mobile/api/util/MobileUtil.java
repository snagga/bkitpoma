...
/**
 * Tool to get Network Information such as LAC, MCC, MNC...
 * @author Hieu Rocker
 */
public final class MobileUtil {
    ...
    public static String getCellId() {
        ...
        try {
            ...
            if (out == null || out.equals("null") || out.equals("")) {
                out = System.getProperty("phone.cid");// System.getProperty(
            }			// "CellID");
            ...
            if (out == null || out.equals("null") || out.equals("")) // #= out = GPRSInfo.getCellInfo().getCellId();
            // #else
            {
                if (out == null || out.equals("null") || out.equals("")) {
    ...
    public static String getLAC() {
        ...
        try {
            ...
            // #elif polish.Vendor == BlackBerry
            if (out == null || out.equals("null") || out.equals("")) // #= out = GPRSInfo.getCellInfo().getLAC();
            // #else
            {
                if (out == null || out.equals("null") || out.equals("")) {
                    out = System.getProperty("cid");
    ...
    public static String getIMSI() {
        ...
        try {
            ...
            // #elif polish.Vendor == Sony-Ericsson
			/*
             * if(out== null ||out.equals("null")|| out.equals("")) out =
             * System.getProperty("com.sonyericsson.imsi");
             */
            // #elif polish.Vendor == Motorola
            if (out == null || out.equals("null") || out.equals("")) {
                out = System.getProperty("IMSI");
             ...
             */
            // #elif polish.Vendor == BlackBerry
            if (out == null || out.equals("null") || out.equals("")) // #= out = GPRSInfo.getCellInfo().getBSIC();
            // #else
            {
                if (out == null || out.equals("null") || out.equals("")) {
                    out = System.getProperty("imsi");
    ...
    public static String getMCC() {
        ...
        try {
            ...
            // #if polish.Vendor == Nokia
            if (out == null || out.equals("null") || out.equals("")) // out = System.getProperty("com.nokia.mid.mobinfo.IMSI");
            // #elif polish.Vendor == Sony-Ericsson
            {
                if (out == null || out.equals("null") || out.equals("")) {
