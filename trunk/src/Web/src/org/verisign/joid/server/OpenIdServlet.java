...
{
    private static Logger log = Logger.getLogger(OpenIdServlet.class.getName());
            ...
            throws ServletException, IOException
    {
        ...
        try {
            ...
            log.log(Level.FINE, "[OpenIdServlet] Logged in as: " + user);
...
if ( request.getParameter(AuthenticationRequest.OPENID_CLAIMED_ID) == null){
                ...
                if (getUserManager().canClaim(user, authReq.getClaimedIdentity())) {
                    ...
                    log.log(Level.FINE, "sending redirect to: " + s);
