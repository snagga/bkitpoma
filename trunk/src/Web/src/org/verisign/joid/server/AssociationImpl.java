...
public class AssociationImpl implements org.verisign.joid.Association {
	...
	private final static Logger log = Logger.getLogger(AssociationImpl.class.getName());
    private Long id;
    private String mode;
	...
	log.log(Level.FINE, "now: "+now.toString());
	Calendar expired = Calendar.getInstance();
	log.log(Level.FINE, "issuedDate: "+issuedDate.toString());
	expired.setTime(issuedDate);
	expired.add(Calendar.SECOND, lifetime.intValue());
	log.log(Level.FINE, "expired: "+expired.toString());
	log.log(Level.FINE, "now.after(expired): "+now.after(expired));
